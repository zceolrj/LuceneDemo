...
public class TopDocs 
{
    ...
    // Specialized MergeSortQueue that just merges by relevance score, descending:
    private static class ScoreMergeSortQueue extends PriorityQueue<ShardRef> 
    {
        ...
        public boolean lessThan(ShardRef first, ShardRef second) 
        {
            ...
            else 
            {
                ...
                {
                    // Tie break in same shard: resolve however the shard had resolved it:
    ...
    public static TopDocs merge(Sort sort, int topN, TopDocs[] shardHits) throws IOException 
    {
        ...
        for(int shardIDX=0;shardIDX<shardHits.length;shardIDX++) 
        {
            ...
            // totalHits can be non-zero even if no hits were collected, when searchAfter was used:
