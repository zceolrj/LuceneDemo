...
public abstract class BufferedIndexInput extends IndexInput 
{
    ...
    {
        assert buffer == null || bufferSize == buffer.length: "buffer=" + buffer + 
            " bufferSize=" + bufferSize + " buffer.length=" + (buffer != null ? buffer.length : 0);
        if (newSize != bufferSize) 
        {
            ...
            if (buffer != null) 
            {
                ...
                // many bytes as possible starting from the current bufferPosition
