...
public abstract class Lock
{
	 ...
	 * "root cause" Exception as to why the lock was not obtained.
	 */
	 ...
	 *            {@link #LOCK_OBTAIN_WAIT_FOREVER} to retry forever
	 * @return true if lock was obtained
	 * @throws LockObtainFailedException if lock wait times out
	 * @throws IllegalArgumentException if lockWaitTimeout is out of bounds
	...
	public abstract static class With
	{
		 ...
		 * 
		 * @throws LockObtainFailedException if lock could not be obtained
