 ...
 * <p>
 * <b>NOTE</b>: In most all cases this will be rather inefficient, requiring
 * four bytes per document. Consider encoding floating point values yourself
 * with only as much precision as you require.
 */
