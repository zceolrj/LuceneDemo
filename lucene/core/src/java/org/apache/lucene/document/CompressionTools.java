 ...
 * binary data for stored fields. This class uses java.util.zip.Deflater and
 * Inflater classes to compress and decompress.
 */
...
public class CompressionTools
{
	 ...
	 * (constants are defined in java.util.zip.Deflater).
	 */
	...
	/**
	 * Decompress the byte array previously returned by compress (referenced by
	 * the provided BytesRef)
	 */
	...
	/**
	 * Decompress the byte array previously returned by compressString back into
	 * a String
	 */
