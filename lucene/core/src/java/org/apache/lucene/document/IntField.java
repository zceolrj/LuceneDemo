...
/**
 * <p>
 * Field that indexes <code>int</code> values for efficient range filtering and
 ...
 *
 * <p>
 * To perform range querying or filtering against a <code>IntField</code>, use
 * {@link NumericRangeQuery} or {@link NumericRangeFilter}. To sort according to
 * a <code>IntField</code>, use the normal numeric sort types, eg
 ...
 *
 * <p>
 * You may add the same field name as an <code>IntField</code> to the same
 ...
 * sort, you should separately index a single-valued <code>IntField</code>.
 * </p>
 *
 * <p>
 * An <code>IntField</code> will consume somewhat more disk space in the index
...
public final class IntField extends Field
{
	...
	/**
	 * Type for an IntField that is not stored: normalization factors,
	...
	/**
	 * Type for a stored IntField: normalization factors, frequencies, and
	...
	/**
	 * Creates a stored or un-stored IntField with the provided value and
	 ...
	 * @param name     field name
	 * @param value    32-bit integer value
	 * @param type     customized field type: must have {@link FieldType#numericType()} of
	 *                 {@link FieldType.NumericType#INT}.
	 * @throws IllegalArgumentException
	 *             if the field name or type is null, or if the field type does
	...
	public IntField(String name, int value, FieldType type)
	{
		...
		if (type.numericType() != FieldType.NumericType.INT)
		{
			throw new IllegalArgumentException(
					"type.numericType() must be INT but got "
							+ type.numericType());
		}
		fieldsData = Integer.valueOf(value);
	}
