...
final class FreqProxTermsWriter extends TermsHashConsumer 
{
    ...
    // would be nice to factor out more of this, eg the FreqProxFieldMergeState, 
    // and code to visit all Fields under the same FieldInfo together, 
    // up into TermsHash*. Other writers would presumably share a lot of this... 
    @Override
