...
final class DocumentsWriter 
{
    ...
    // cut over to BytesRefHash in BufferedDeletes
    ...
    // we could check w/ FreqProxTermsWriter: if the term doesn't exist, don't bother buffering into the
    ...
    final void subtractFlushedNumDocs(int numFlushed) //subtract   v.减去、扣除
    {
     ...
     */
    final boolean flushAllThreads(final IndexWriter indexWriter) throws IOException 
    {
