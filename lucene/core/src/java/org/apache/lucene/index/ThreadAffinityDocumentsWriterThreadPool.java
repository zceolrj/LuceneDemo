 ...
 */
class ThreadAffinityDocumentsWriterThreadPool extends DocumentsWriterPerThreadPool //affinity   n.亲和力，密切关系，类似，近似
{
    ...
    public ThreadState getAndLock(Thread requestingThread, DocumentsWriter documentsWriter) 
    {
        ...
        /* another thread could lock the minThreadState we just got while 
