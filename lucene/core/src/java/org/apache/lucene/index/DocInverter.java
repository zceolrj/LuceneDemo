...
final class DocInverter extends DocFieldConsumer 
{
    ...
    final InvertedDocEndConsumer endConsumer;//NormsConsumer  used to write nrm
    ...
    {
        // allow endConsumer.finishDocument to also return a DocWriter
        endConsumer.finishDocument();//endConsumer=NormsConsumer
        consumer.finishDocument();//consumer=TermsHash
    }
