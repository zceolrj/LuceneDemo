...
public final class SegmentReader extends AtomicReader 
{
    ...
    // Normally set to si.docCount - si.delDocCount, unless we were created 
    // as an NRT reader from IW, in which case IW tells us the docCount:
    ...
    public SegmentReader(SegmentInfoPerCommit si, int termInfosIndexDivisor, IOContext context) throws IOException 
    {
        ...
        finally 
        {
            ...
            // In this case, we want to explicitly close any subset of things that were opened so that 
            // we don't have to wait for a GC to do so.
            if (!success) 
            {
                core.decRef();
            }
    ...
    // will map to the same entry in the FieldCache.  See LUCENE-1579.
    @Override
    public Object getCoreCacheKey() 
    {
        // NOTE: if this ever changes, be sure to fix SegmentCoreReader.notifyCoreClosedListeners to match!
