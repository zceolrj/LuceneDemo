...
final class DocumentsWriterDeleteQueue 
{
    ...
    private static final AtomicReferenceFieldUpdater<DocumentsWriterDeleteQueue,Node> tailUpdater = 
                                 AtomicReferenceFieldUpdater.newUpdater(DocumentsWriterDeleteQueue.class, Node.class, "tail");
    ...
    DocumentsWriterDeleteQueue(BufferedDeletes globalBufferedDeletes, long generation) 
    {
        ...
        /*
         * we use a sentinel(岗哨，哨兵) instance as our initial tail. No slice will ever try to
         * apply this tail since the head is always omitted.(省略)
         */
    ...
    void add(Term term, DeleteSlice slice) 
    {
        ...
        tryApplyGlobalSlice(); // doing this each time is not necessary maybe
    ...
    boolean anyChanges() 
    {
        ...
        try 
        {
             ...
             */
            return globalBufferedDeletes.any() || !globalSlice.isEmpty() || globalSlice.sliceTail != tail || tail.next != null;
        } 
        finally 
        {
    ...
    FrozenBufferedDeletes freezeGlobalBuffer(DeleteSlice callerSlice) 
    {
        ...
        // Changes after this call are applied later and not relevant here
        if (callerSlice != null) 
        {
