...
{
    final TermsHashConsumer consumer;//FreqProxTermsWriter  used to write freq, prox
    final TermsHash nextTermsHash;//nextTermsHash.consumer=TermVectorsConsumer  used to write tvx, tvd, tvf
    ...
    {
        consumer.finishDocument(this);//consumer=FreqProxTermsWriter
        if (nextTermsHash != null) 
        {
            nextTermsHash.consumer.finishDocument(nextTermsHash);//nextTermsHash.consumer=TermVectorsConsumer
        }
    }
    ...
    {
        consumer.startDocument();//consumer=FreqProxTermsWriter
        if (nextTermsHash != null) 
        {
            nextTermsHash.consumer.startDocument();//nextTermsHash.consumer=TermVectorsConsumer
        }
    }
}
