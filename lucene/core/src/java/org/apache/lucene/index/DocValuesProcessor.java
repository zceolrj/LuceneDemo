...
{
    // somewhat wasteful we also keep a map here; would
    ...
    void addBinaryField(FieldInfo fieldInfo, int docID, BytesRef value) 
    {
        ...
        {
            throw new IllegalArgumentException("Incompatible DocValues type: field \"" + 
                               fieldInfo.name + "\" changed from " + getTypeDesc(writer) + " to binary");
        } 
        else 
        {
    ...
    void addSortedField(FieldInfo fieldInfo, int docID, BytesRef value) 
    {
        ...
        {
            throw new IllegalArgumentException("Incompatible DocValues type: field \"" + 
                               fieldInfo.name + "\" changed from " + getTypeDesc(writer) + " to sorted");
        } 
        else 
        {
    ...
    void addNumericField(FieldInfo fieldInfo, int docID, long value) 
    {
        ...
        {
            throw new IllegalArgumentException("Incompatible DocValues type: field \"" + 
                                fieldInfo.name + "\" changed from " + getTypeDesc(writer) + " to numeric");
        } 
        else 
        {
