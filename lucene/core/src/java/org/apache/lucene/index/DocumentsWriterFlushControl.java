  ...
  ThreadState obtainAndLock() 
  {
    ...
    void markForFullFlush() 
    {
        ...
        synchronized (this) 
        {
            ...
            // Set a new delete queue - all subsequent DWPT will use this queue until we do another full flush
        ...
        synchronized (this) 
        {
            /* make sure we move all DWPT that are where concurrently marked as pending and moved to blocked 
             * are moved over to the flushQueue. There is a chance that this happens since we marking DWPT 
             * for full flush without blocking indexing.*/
