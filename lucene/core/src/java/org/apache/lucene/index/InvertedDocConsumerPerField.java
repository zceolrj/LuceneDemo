...
{
    // Called once per field, and is given all IndexableField occurrences for this field in the document.  
    ...
    // Called once per field per document, after all IndexableFields are inverted
