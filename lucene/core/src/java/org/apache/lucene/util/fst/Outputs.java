 ...
 *
 * <p>
 * Note that any operation that returns NO_OUTPUT must return the same singleton
 * object from {@link #getNoOutput}.
 * </p>
 *
 * @lucene.experimental
 */
...
public abstract class Outputs<T>
{
	...
	/**
	 * Encode an final node output value into a {@link DataOutput}. By default
	 * this just calls {@link #write(Object, DataOutput)}.
	 */
	...
	/**
	 * Decode an output value previously written with
	 * {@link #writeFinalOutput(Object, DataOutput)}. By default this just calls
	 * {@link #read(DataInput)}.
	 */
	...
	/**
	 * NOTE: this output is compared with == so you must ensure that all methods
	 * return the single object if it's really no output
	 */
