...
public final class BytesRefHash 
{
    ...
    {
        final int[] compact = compact();//compact  v.压紧   adj.紧凑的
        new IntroSorter() 
        {
            @Override
     ...
     * 
     * @param bytes  the bytes to hash
     * @param code   the bytes hash code
     * 
     *          <p>
    ...
    {
        // can't we just merge this w/
        // TrackingDirectBytesStartArray...?  Just add a ctor that makes a private bytesUsed?
