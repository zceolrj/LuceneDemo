...
{
    // hmmm, what about an iterator that finds zeros though, or a reverse iterator... 
    // should they be separate classes for efficiency, or have a common root interface?  
    // (or maybe both?  could ask for a SetBitsIterator, etc...
