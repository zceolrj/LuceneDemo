...
public final class ArrayUtil
{
	 ...
	 * @throws NumberFormatException if the argument could not be parsed as an
	 *             int quantity.
	 */
	 ...
	 * @param bytesPerElement Bytes used by each element of the array. See
	 *            constants in {@link RamUsageEstimator}.
	 *
	 * @lucene.internal
	 */
	 ...
	 */
	public static boolean equals(byte[] left, int offsetLeft, byte[] right,
			int offsetRight, int length)
	{
		if ((offsetLeft + length <= left.length)
				&& (offsetRight + length <= right.length))
	...
	/**
	 * Sorts the given array slice using the {@link Comparator}. This method
	 * uses the intro sort algorithm, but falls back to insertion sort for small
	 * arrays.
	 * 
	 * @param fromIndex start index (inclusive)
	 * @param toIndex end index (exclusive)
	 */
	public static <T> void introSort(T[] a, int fromIndex, int toIndex,
	...
	/**
	 * Sorts the given array slice using the {@link Comparator}. This method
	 * uses the Tim sort algorithm, but falls back to binary sort for small
	 * arrays.
	 * 
	 * @param fromIndex start index (inclusive)
	 * @param toIndex end index (exclusive)
	 */
	public static <T> void timSort(T[] a, int fromIndex, int toIndex,
			Comparator<? super T> comp)
	{
		if (toIndex - fromIndex <= 1)
		{
	...
	/**
	 * Sorts the given array slice in natural order. This method uses the Tim
	 * sort algorithm, but falls back to binary sort for small arrays.
	 * 
	 * @param fromIndex start index (inclusive)
	 * @param toIndex end index (exclusive)
	 */
