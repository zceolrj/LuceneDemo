...
public final class RamUsageEstimator 
{
    ...
    static 
    {
        // Initialize empirically measured defaults. We'll modify them to the current JVM settings later on if possible.
        int referenceSize = Constants.JRE_IS_64BIT ? 8 : 4;
        int objectHeader = Constants.JRE_IS_64BIT ? 16 : 8;
        // The following is objectHeader + NUM_BYTES_INT, but aligned (object alignment) so on 64 bit JVMs it'll be align(16 + 4, @8) = 24.
        ...
        // If the scaling is byte-wise and unsafe is available, enable dynamic size measurement for estimateRamUsage().
        ...
        // Try to get the object alignment (the default seems to be 8 on Hotspot, regardless of the architecture).
    ...
    private static long adjustForField(long sizeSoFar, final Field f) 
    {
        ...
        if (objectFieldOffsetMethod != null) 
        {
            ...
            catch (InvocationTargetException ite) 
            {
                ...
                // this should never happen (Unsafe does not declare checked Exceptions for this method), but who knows?
