...
final class Lucene42FieldInfosWriter extends FieldInfosWriter
{
	...
	@Override
	public void write(Directory directory, String segmentName,
			FieldInfos infos, IOContext context) throws IOException
	{
		...
		try
		{
			CodecUtil.writeHeader(output, Lucene42FieldInfosFormat.CODEC_NAME,
