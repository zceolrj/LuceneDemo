 ...
 * <p>
 * <p>
 * Field names are stored in the field info file, with suffix <tt>.fnm</tt>.
 * </p>
 * <p>
 * FieldInfos (.fnm) --&gt; Header,FieldsCount, &lt;FieldName,FieldNumber,
 * FieldBits,DocValuesBits,Attributes&gt; <sup>FieldsCount</sup>
 * </p>
 * <p>
 * Data types:
 * <ul>
 ...
 * <li>Attributes --&gt; {@link DataOutput#writeStringStringMap
 ...
 * Lucene, the fields are not numbered implicitly by their order in the file,
 * instead explicitly.</li>
 ...
 * <li>If the third lowest order-bit is set (0x4), offsets are stored into the
 * postings list in addition to positions.</li>
 ...
 * <li>If the eighth lowest-order bit is set (0x80), positions are omitted for
