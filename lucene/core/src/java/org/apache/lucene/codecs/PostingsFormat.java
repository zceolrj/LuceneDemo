...
{
	private static final NamedSPILoader<PostingsFormat> loader = new NamedSPILoader<PostingsFormat>(
			PostingsFormat.class);
	 ...
	 * configurations (such as when using {@link PerFieldPostingsFormat}): in
	...
	/**
	 * Reads a segment. NOTE: by the time this call returns, it must hold open
	 * any files it will need to use; else, those files may be deleted.
	 * Additionally, required files may be deleted during the execution of this
	 * call before there is a chance to open them. Under these circumstances an
	 * IOException should be thrown by the implementation. IOExceptions are
	 ...
	 * 
	 * <p>
	 * <b>NOTE:</b> Only new postings formats are added, existing ones are never
	 * removed or replaced.
	 * 
	 * <p>
