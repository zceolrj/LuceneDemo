...
public abstract class MultiLevelSkipListWriter
{
	...
	protected MultiLevelSkipListWriter(int skipInterval, int skipMultiplier,
			int maxSkipLevels, int df)
	{
		...
		{
			numberOfSkipLevels = 1 + MathUtil.log(df / skipInterval,
					skipMultiplier);
		}
	...
	/**
	 * Creates a {@code MultiLevelSkipListWriter}, where {@code skipInterval}
	 * and {@code skipMultiplier} are the same.
	 */
