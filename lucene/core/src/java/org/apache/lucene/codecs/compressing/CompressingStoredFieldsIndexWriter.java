...
{ 
    ...
    private void writeBlock() throws IOException 
    {
        ...
        // The trick here is that we only store the difference from the average start pointer or doc base, 
        // this helps save bits per value. And in order to prevent a few chunks that would be far from 
        // the average to raise the number of bits per value for all of them, 
        // we only encode blocks of 1024 chunks at once
        // See LUCENE-4512
